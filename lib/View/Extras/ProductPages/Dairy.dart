...
class _DairyState extends State<Dairy> {
  ...
  Widget productsGrid() {
    ...
    return GridView.builder(
        ...
        itemCount: itemController.eggs.length,
        shrinkWrap: true,
                  ...
                  children: [
                    Column(
                        ...
                        children: [
                          ...
                          cardTitle(itemController.eggs.elementAt(index).title),
                          Row(
                            children: [
                              showTexts(
                                  "${itemController.eggs.elementAt(index).count}pcs,"),
                              showTexts(" Price"),
                            ],
                          ),
                          const SizedBox(
